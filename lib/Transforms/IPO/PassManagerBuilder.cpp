...
static cl::opt<bool> DivFunction("fdiv", cl::init(false),
                                cl::desc("Enable the diverse function"));

static cl::opt<bool> DupFunction("fdp", cl::init(false),
                                cl::desc("Enable the duplicate function"));

static cl::opt<bool> ArrayObfs("arr", cl::init(false),
                                cl::desc("Enable the array obfuscation"));

static cl::opt<bool> SplitFunction("fsp", cl::init(false),
                                cl::desc("Enable the split function"));
...
void PassManagerBuilder::populateModulePassManager(PassManagerBase &MPM) {
  MPM.add(createDivFunction(DivFunction));
  MPM.add(createDupFunction(DupFunction));
  MPM.add(createSplitFunction(SplitFunction));
  MPM.add(createArrayObfs(ArrayObfs));
